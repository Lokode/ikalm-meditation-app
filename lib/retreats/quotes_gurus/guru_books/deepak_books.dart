...
class DeepakBooksListview extends StatelessWidget {
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: ListView(scrollDirection: Axis.horizontal, children: <Widget>[
            ...
            BooksContainers('images/guru_books/dcb1.jpg',  Eckhart()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
            BooksContainers('images/guru_books/dcb2.jpg',  Alan()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
            BooksContainers('images/guru_books/dcb3.jpg',  Jiddu()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
            BooksContainers('images/guru_books/dcb4.jpg', Ramana()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
            BooksContainers('images/guru_books/dcb5.jpg', Thich()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
            BooksContainers('images/guru_books/dcb6.jpg', DalaiLama()),
            SizedBox(
              width: _sizeBoxwidth,
            ),
